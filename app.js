...
window.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        loadingState.innerHTML = `<i data-lucide="alert-triangle" style="color:#d4af37; width:48px; height:48px; margin-bottom: 1rem;"></i><p style="color:white; text-align: center;">Error: No se encontró 'data.xlsx'.<br>Asegúrate de que el archivo existe en la ruta correcta.</p>`;
        lucide.createIcons();
    }
});
